...
<body class="bg-white font-sans text-ink antialiased overflow-y-scroll">
  ...
  <main class="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:py-12 min-h-[70vh]">
    ...
    <div class="grid grid-cols-2 gap-3.5 sm:grid-cols-3 lg:grid-cols-5">
        ...
        <!-- 5. KosanLaundry (Arahkan ke Modal Coming Soon) -->
        ...
        <!-- 6. KosanMart (Arahkan ke Modal Coming Soon) -->
        ...
        <!-- 7. KosanStorage (Arahkan ke Modal Coming Soon) -->
        ...
        <!-- 8. Lapor Masalah (Arahkan ke Modal Coming Soon) -->
       ...
       <!-- 9. KOKA Rewards (Arahkan ke Modal Coming Soon & ubah jadi tag button) -->
        <button onclick="openComingSoon('KOKA Rewards')" class="group w-full flex flex-col items-start gap-3 rounded-2xl border border-[#e2e8f0] bg-white p-4 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#E5B044]/40 hover:shadow-md sm:p-5 cursor-pointer">
          <div class="grid h-12 w-12 place-items-center rounded-xl bg-[#f8fafc] text-[#0b2046] transition group-hover:bg-[#0b2046] group-hover:text-[#E5B044]">
        ...
        <!-- 10. KOKA Care (Arahkan ke Modal Coming Soon & ubah jadi tag button) -->
        <button onclick="openComingSoon('KOKA Care')" class="group w-full flex flex-col items-start gap-3 rounded-2xl border border-[#e2e8f0] bg-white p-4 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#E5B044]/40 hover:shadow-md sm:p-5 cursor-pointer">
          <div class="grid h-12 w-12 place-items-center rounded-xl bg-[#f8fafc] text-[#0b2046] transition group-hover:bg-[#0b2046] group-hover:text-[#E5B044]">
  ...
  <!-- ================= MODAL COMING SOON ================= -->
  <!-- Mengubah "items-end" menjadi "items-center" dan menambahkan "p-4" agar ada jarak dari tepi layar HP -->
  <div id="comingSoonModal" class="fixed inset-0 z-[100] hidden items-center justify-center p-4 sm:p-0 transition-opacity">
    
    <!-- Overlay Gelap -->
    <div class="absolute inset-0 bg-[#0b2046]/40 backdrop-blur-sm transition-opacity" onclick="closeComingSoon()"></div>
    
    <!-- Kotak Modal (Selalu di Tengah Layar) -->
    <!-- Menyamakan lengkungan sudut menjadi rounded-[24px] di semua perangkat -->
    <div role="dialog" aria-modal="true" class="relative flex w-full max-w-sm flex-col overflow-hidden rounded-[24px] sm:rounded-[32px] bg-white shadow-2xl animate-in-up">
      ...
      <!-- Konten Modal -->
      <div class="flex flex-col items-center px-6 py-8 sm:py-10 text-center">
        ...
        <!-- Judul Dinamis -->
        <h4 class="mt-5 sm:mt-6 font-display text-[18px] sm:text-[20px] font-extrabold text-[#0b2046]">Fitur yang akan datang</h4>
        
        <p class="mt-2 text-[13px] sm:text-[14px] leading-relaxed text-[#64748b]">
  ...
  <!-- SCRIPT UNTUK COMING SOON MODAL -->
  <script>
      function openComingSoon(title) {
          // Ganti teks judul layanan di dalam popup
